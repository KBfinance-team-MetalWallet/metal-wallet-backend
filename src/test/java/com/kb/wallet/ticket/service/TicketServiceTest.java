...
class TicketServiceTest {
  ...
  void cancelTicket_Success() {
    ...
    // given
    when(ticketRepository.findByMember(ticketId, member.getEmail())).thenReturn(Optional.of(ticket));
  ...
  void cancelTicket_NotFound() {
    ...
    // given
    when(ticketRepository.findByMember(ticketId, "test@example.com")).thenReturn(Optional.empty());
